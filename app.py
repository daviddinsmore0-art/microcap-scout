...
def render_portfolio_row(row, data, token=None, rank_map=None):
    ...
    if g_label and g_top:
        rank_lines.append(
            ...
            f"<span style='color:{get_rank_color(g_label)}; background:{get_rank_bg(g_label)}; padding:1px 1px; border-radius:999px; font-weight:700;'>{g_label}</span> "
    ...
    if s_label and s_top:
        ...
        rank_lines.append(
            ...
            f"<span style='color:{get_rank_color(s_label)}; background:{get_rank_bg(s_label)}; padding:1px 1px; border-radius:999px; font-weight:700;'>{s_label}</span> "

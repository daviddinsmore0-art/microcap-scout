...
.block-container{
    padding-top: 0.25rem !important;
        ...
        .risk-row { display: flex; justify-content: space-between; align-items: center; margin: 30px 0 10px 0; border-bottom: 1px solid #2d3748; padding-left:30px; padding-bottom: 15px; }

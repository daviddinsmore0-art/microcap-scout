      ...
      <div class="card port-row" data-flip-id="{row['ticker']}" style="display:flex; justify-content:space-between; align-items:center; border-left: 4px solid {color};">
        <div>
          <div style="display:flex; align-items:center; gap:8px;">
            ...
            <div style="display:flex; align-items:center; gap:8px;">
              <div style="font-size:1.1rem; background:{color}; color:black; padding:2px 6px; border-radius:6px; font-weight:bold;">RISK: {risk}</div>
              <div style="font-size:1.1rem; background:{conf_bg}; color:black; padding:2px 6px; border-radius:6px; font-weight:bold;">CONF: {conf}</div>
            </div>
          </div>

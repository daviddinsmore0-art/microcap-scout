...
def create_gauge_html(score, label, color, size="big"):
    ...
    # Flattened HTML to fix render bugs
...
def render_portfolio_row(row, market_data, current_token):
    ...
    # FIXED: Replaced nested tags and entities with clean single-line strings
    pl_html = ""
    if shares > 0 and entry > 0:
        ...
        # Using bullet point instead of nbsp

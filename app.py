...
# TODAY'S SIGNAL SHIFT (Biggest Rank Jump)
    ...
    if radar_rows:
      ...
      <div style="margin-bottom:10px;">
        ...
        <span style="color:{chg_color}; font-weight:700;"> {chg_txt}</span><span style="opacity:0.85; padding-left:10px; color:#f5d07a;">{holds_txt} Holds</span> Alerted {(' • ' + mins_txt) if mins_txt else ''}<br>

...
def render_portfolio_row(row, data, token):
    ...
    html = f"""
    html = f"""
<a href="/stock/{row['ticker']}" style="text-decoration:none;">
<div style="display:flex; justify-content:space-between; align-items:center; padding:14px;">
    ...
    <div>
        <div style="display:flex; align-items:center; gap:8px;">
            ...
            <div style="display:flex; align-items:center; gap:8px;">
                <div style="font-size:0.6rem; background:{color}; color:black;
                            padding:2px 6px; border-radius:6px; font-weight:bold;">
                    RISK: {risk}
                </div>

                <div style="font-size:0.6rem; background:{conf_bg}; color:black;
                            padding:2px 6px; border-radius:6px; font-weight:bold;">
                    CONF: {conf}
                </div>
            </div>
        ...
        <div style="font-size:0.75rem; color:#9aa4b2; margin-top:2px;">
            {company_name}
        </div>

        <div style="font-size:0.65rem; color:#7a8594; margin-top:2px;">
            Updated {updated_str}
        </div>
    ...
    <div style="text-align:right;">
        ...
        <div style="color:{change_color}; font-size:0.85rem;">
            {arrow} {change:.2f}%
        </div>
    </div>

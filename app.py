...
def render_portfolio_row(row, data, token=None, rank_map=None):
    ...
    factors = []
    if momo is not None: factors.append(f"<span style='color:#4ade80; background: rgba(74, 222, 128, 0.12); padding:2px 6px; border-radius:6px;'>Momentum <b>{momo}</b></span>")
    if qual is not None: factors.append(f"<span style='color:#60a5fa;background: rgba(96, 165, 250, 0.12); padding:2px 6px; border-radius:6px;'>Quality <b>{qual}</b></span>")
    if val  is not None: factors.append(f"<span style='color:#fb923c;background: rgba(251, 146, 60, 0.12); padding:2px 6px; border-radius:6px;'>Value <b>{val}</b></span>")
    if stab is not None: factors.append(f"<span style='color:#a78bfa;background: rgba(167, 139, 250, 0.12); padding:2px 6px; border-radius:6px;'>Stability <b>{stab}</b></span>")
